$(document).ready(() => {
  ...
  const doSearch = () => {
    ...
    let apikey = "AIzaSyBPmmmehRo35A8q6cey3n8Z5pdjqJEVvQ0"; 
    let url = 'https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&key='+apikey+'&q=' + searchQuery + '&order=viewCount ';
